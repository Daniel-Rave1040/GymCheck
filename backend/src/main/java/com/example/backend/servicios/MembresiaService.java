...
import com.example.backend.entidades.Pago;
import com.example.backend.dto.VentaMembresiaRequest;
import com.example.backend.persistencia.ClienteMembresiaRepository;
...
public class MembresiaService {
    ...
    public ClienteMembresia comprarMembresia(VentaMembresiaRequest request) {
        ...
        if (cliente == null) {
            ...
            // Si el frontend envía nombre con apellido junto o separado, por simplicidad
            // guardamos todo en nombre o verificamos si hay espacio.
        ...
        List<ClienteMembresia> membresiasAnteriores = clienteMembresiaRepository
                .findMembresiasByClienteIdDesc(cliente.getIdCliente());
    ...
    public long calcularDiasRestantesPorDocumento(String documento) {
        ...
        // Reutiliza la lógica existente con el ID del cliente encontrado
        return calcularDiasRestantes(cliente.getIdCliente());
    }
